...
//        cards : [
//         {
//             image : "https://www.thejunctionshopping.com/wp-content/uploads/2017/03/Burger-King.png",
//             name : "Burger King",
...
const Body = () => {
    return (
        <>
            <input className="search-bar" type="text" placeholder="Search Restaurant" ></input>
            <div className='restaurant-list'>
                {/* <h3>Restaurant List</h3> */}
                {/* 1st Way To write like this */}
                ...
                {/* 2nd Way To write like this */}
                {/* <RestaurantCard name={restaurantList[0].data?.name} />
                <RestaurantCard cuisines={restaurantList[1].data?.cuisines}/> */}
                
                {/* 3rd Way To write like this */}
